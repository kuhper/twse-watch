"""Disposition assessment (stages 1 and 2).

乾淨備援模組：與 disposition.py 內容相同。引擎優先載入 disposition.py，
若該檔在某些檔案系統出現問題則自動改用本檔。官方處置標準（要點第六條）：
連續3個營業日 / 最近5日內5次 / 最近10日內6次 / 最近30日內12次 達注意標準即處置。
"""
